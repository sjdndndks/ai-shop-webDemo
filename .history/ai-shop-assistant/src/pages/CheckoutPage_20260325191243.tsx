    ...
    const loadSettings = async () => {
      try {
        ...
        setSelectedPaymentMethodId(
          settings.paymentMethods.find((paymentMethod) => paymentMethod.isDefault)
            ?.id ||
          ...
          <div className={styles.grid}>
            <section className={styles.formCard}>
              <div className={styles.form}>
                <div className={styles.section}>
                  ...
                  {loadingSettings ? (
                    <div className={styles.paymentHint}>正在加载账户信息...</div>
                    ...
                    <div className={styles.optionList}>
                      {accountSettings.addresses.map((address) => (
                        ...
                        >
                          ...
                          <div className={styles.optionDetail}>{address.address}</div>
                        </button>
                      ))}
                    </div>
                  ) : (
                ...
                <div className={styles.section}>
                  ...
                  {loadingSettings ? (
                    <div className={styles.paymentHint}>正在加载支付方式...</div>
            ...
            <aside className={styles.summaryCard}>
              ...
              {selectedItems.length === 0 ? (
                <div className={styles.emptyState}>当前没有勾选任何要结算的商品。</div>
              ) : (
